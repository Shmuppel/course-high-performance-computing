...
class AveragePhredCalculator:
    ...
    def __init__(self, phred_score_lines, no_processes):
        ...
        phred_score_matrices = self.multiprocess(no_processes, phred_score_lines)
    ...
    def multiprocess(self, no_processes, phred_score_lines):
        """
        :param no_processes:
        ...
        for p in range(no_processes):
            ...
            process = mp.Process(target=self.process_function,
                                 args=(process_no,
    ...
    def process_function(self, process_no, phred_score_lines_subset, max_read_length, output_queue):
        """

        :return:
        """
        print("{process} - Preallocating NumPy matrix subset...".format(process=process_no))
        phred_score_matrix = self.preallocate_numpy_matrix(phred_score_lines_subset, max_read_length)
        print("{process} - Filling matrix with numerical Phred scores...".format(process=process_no))
        phred_score_matrix = self.phred_lines_to_matrix(phred_score_lines_subset, phred_score_matrix)
    ...
    def preallocate_numpy_matrix(self, phred_score_lines, max_read_length):
        """
    ...
    def phred_lines_to_matrix(self, phred_score_lines, phred_score_matrix):
        """
